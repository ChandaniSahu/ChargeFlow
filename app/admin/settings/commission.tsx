...
export default function Commission() {
  const commisionData = data.settings.commission;
    ...
    <div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <Input
          ...
          value={commisionData.commissionStructure.platformCommissionPercent}
        />
        <Input
          label="Payment Processing Fee (%)"
          value={commisionData.commissionStructure.paymentProcessingFeePercent}
        />
        <Input
          label="Minimum Booking Amount (₹)"
          value={commisionData.commissionStructure.minimumBookingAmount}
        />
        <Input
          label="Maximum Booking Amount (₹)"
          value={commisionData.commissionStructure.maximumBookingAmount}
        />
      </div>
      ...
      <Toggle
        ...
        enabled={commisionData.dynamicPricing.peakHourPricing}
      />

      <Toggle
        title="Weekend Premium"
        subtitle="Apply premium pricing on weekends"
        enabled={commisionData.dynamicPricing.weekendPremium}
      />
    </div>
  );
}
