...
const VehicleTypeModal = ({ open, onClose }: { open: boolean; onClose: () => void }) => {
  ...
  const handleVehicleClick = (type: string) => {
    onClose(); // close modal
    router.push(`/selectvehicle?type=${type}`); // same as first code
  };
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center z-[150] px-4 sm:px-0">
        <div className="font-roboto bg-white rounded-[20px] p-4 sm:p-6 pb-8 sm:pb-12 w-full max-w-[942px] max-h-[90vh] overflow-y-auto
    sm:max-h-none sm:overflow-visible">
          ...
          <div className="mb-4 sm:mb-6">
            <div className="flex items-center gap-3 sm:gap-5">
              ...
              <h1 className="text-[22px] sm:text-[36px] font-semibold">
          ...
          {/* Vehicle Cards */}
          <div className="mx-auto grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-x-10 sm:max-w-[440px]">
            {vehicles.map(vehicle => (
              <div
                ...
                rounded-[17px] shadow-[0px_2.84px_7.67px_0px_rgba(0,0,0,0.2)] cursor-pointer
              ...
              >
                <div className="flex flex-col items-center justify-center h-full">
                  ...
                  />
                  <h3 className="text-[16px] sm:text-[20px] font-medium mt-2">
                    {vehicle.label}
                  </h3>
                </div>
              </div>
